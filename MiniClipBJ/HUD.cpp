...
{
	textObjects.push_back(new TextObject("Assets/Fonts/bst.ttf", 80, "Score", {0, 0, 0, 255}, startX, startY));
	scoreText = new TextObject("Assets/Fonts/bst.ttf", 60, "0", {0, 0, 0, 255 }, startX, startY+100);
	textObjects.push_back(new TextObject("Assets/Fonts/bst.ttf", 80, "Time", { 0,0,0,255 }, startX, startY+200));
	timeText = new TextObject("Assets/Fonts/bst.ttf", 60, "00:00", { 0,0,0,255 }, startX, startY + 300);
	...
	formattedTime << std::setw(2) << std::setfill('0') << maxTime / 60 << ":" << std::setw(2) << std::setfill('0') << maxTime % 60;
